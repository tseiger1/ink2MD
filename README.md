...
Ink2MD is an Obsidian plugin that brings handwritten notebooks into your vault. It scans configurable folders, turns the discovered pages into PNG files, and asks a vision LLM (OpenAI, Anthropic, Google Gemini, or a local llama-style endpoint) to create Markdown notes for every import.
...
- Generate Markdown summaries through OpenAI, Anthropic, Google Gemini, or any OpenAI-compatible local endpoint.
